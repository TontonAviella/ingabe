...
export class BasemapControl implements IControl {
  ...
  private _boundDocumentClick: ((e: Event) => void) | undefined;
  ...
  onAdd(_map: MLMap): HTMLElement {
    ...
    menu.style.gridTemplateColumns = 'repeat(3, 120px)';
    menu.style.gap = '8px';
    ...
    // Close menu when clicking outside — store bound reference so we can remove it
  ...
  onRemove(): void {
    if (this._boundDocumentClick) {
      ...
      this._boundDocumentClick = undefined;
    }
