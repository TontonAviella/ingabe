...
def main() -> None:
    ...
    app_env = {
        ...
        "OPENAI_BASE_URL": env("OPENAI_BASE_URL", "https://ollama.com/v1"),
        "OPENAI_MODEL": env("OPENAI_MODEL", "gemma4:31b"),
        "SAGE_SMALL_TALK_MODEL": env("SAGE_SMALL_TALK_MODEL", "gemma4:31b"),
        "BRAIN_QUERY_EXPANSION_MODEL": env("BRAIN_QUERY_EXPANSION_MODEL", "gemma4:31b"),
