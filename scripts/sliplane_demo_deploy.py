...
def main() -> None:
    ...
    app_env = {
        ...
        "OPENAI_MODEL": env("OPENAI_MODEL", "nvidia/nemotron-3-super-120b-a12b:free"),
        "SAGE_SMALL_TALK_MODEL": env("SAGE_SMALL_TALK_MODEL", "nvidia/nemotron-3-super-120b-a12b:free"),
        "BRAIN_QUERY_EXPANSION_MODEL": env("BRAIN_QUERY_EXPANSION_MODEL", "nvidia/nemotron-3-super-120b-a12b:free"),
