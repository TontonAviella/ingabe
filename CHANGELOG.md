...
- Alembic migration `a1b2c3d4e5f7` creating `insurance_triggers` table with 34 seed rows covering maize, beans, and rice across Seasons A and B. Check constraints, composite unique index, and `updated_at` trigger.
...
- 121 unit tests covering pure functions, async mocked integration, and migration integrity (0.58s).
