...
is also available as a self-hosted set of Docker images, credited to Roger, with full support for [local LLMs](/deployments/connecting-to-local-llm-with-ollama/).
