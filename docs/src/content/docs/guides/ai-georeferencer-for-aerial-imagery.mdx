...
The [AI Georeferencer](https://app.mundi.ai/tools/ai-georeferencer/aerial) in Mundi takes
...
<div style={{ textAlign: 'center' }}>
  <LinkButton href="https://app.mundi.ai/tools/ai-georeferencer/aerial" icon="right-arrow">
    **Try AI georeferencer**
  </LinkButton>
</div>
...
for a new region, please reach out to us on Discord or GitHub.
