...
[Open source Mundi](https://github.com/Ingabe/mundi.ai) includes built-in support for visualizing [point cloud data](https://en.wikipedia.org/wiki/Point_cloud). You
