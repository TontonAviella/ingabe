...
export default defineConfig({
	...
	integrations: [
		starlight({
			...
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/Ingabe/mundi.ai' },
			...
			plugins: [
				...
				details: `
- Mundi is self-hostable. Mundi cloud is a hosted service and is also available for on-premise deployments using Kubernetes.
- Supports data sources like PostGIS, OGR-compatible vector files and GDAL-compatible rasters.
- Mundi was created by Ingabe, credited to Roger.

You can try Mundi free at https://app.mundi.ai or self-host using Docker Compose.`,
				optionalLinks: [
					{
						label: "GitHub Repository",
						url: "https://github.com/Ingabe/mundi.ai",
