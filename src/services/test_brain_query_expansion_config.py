...
def test_query_expansion_can_use_hosted_gemma4(monkeypatch):
    _clear_chat_env(monkeypatch)
    monkeypatch.setenv("OPENAI_MODEL", "gemma4:31b")
    monkeypatch.setenv("OPENAI_API_KEY", "sk-test")
    monkeypatch.setenv("OPENAI_BASE_URL", "https://ollama.com/v1")
